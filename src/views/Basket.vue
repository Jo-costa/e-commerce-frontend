<template>
    ...
    <div class="font-[sans-serif] bg-gray-100">
        <div class=" grid lg:grid-cols-3 gap-12 p-20" v-if="cart.length > 0">
            ...
            <div class="bg-white rounded p-6 grid-rows-1	">
                <h3 class="flex text-xl font-extrabold text-[#333] border-b pb-4">Order Summary</h3>
                <ul class="text-[#333] divide-y mt-6">
                    <li class="flex flex-wrap gap-4 text-md py-4">Subtotal <span class="font-bold">$46.00</span>
                    </li>
                    <li class="flex flex-wrap gap-4 text-md py-4">Shipping <span class="font-bold">$4.00</span>
                    </li>
                    <li class="flex flex-wrap gap-4 text-md py-4">Tax <span class="font-bold">$4.00</span>
                    </li>
                    <li class="flex flex-wrap gap-4 text-md py-4 font-bold">Total <span class="">$54.00</span>
                    </li>
                </ul>
                <button type="button"
